"""
Django settings for nebulous_project.
Optimized for containerized Azure deployment.
"""
...
ROOT_URLCONF = 'nebulous_project.urls'
...
WSGI_APPLICATION = 'nebulous_project.wsgi.application'
