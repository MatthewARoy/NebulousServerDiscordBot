#!/bin/bash
# Deployment script for Azure Container Apps (Local Build Version)
# Use this if ACR Tasks is not available on your subscription
...
echo "🚀 Deploying Nebulous Discord Bot to Azure (Local Build)"
echo "=========================================="
...
# Build Docker image locally for AMD64 (Azure requirement)
...
if [ ! -f .env ]; then
    ...
    # Create or update container app with secrets
